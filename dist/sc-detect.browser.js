...
(() => {
  ...
  var WatchdogHandle = class {
    ...
    onNewScoreCalculated() {
      const analysis = this.getLastAnalysis();
      this.listeners.forEach((listener) => {
        listener(analysis);
      });
    }
    addEventListenerOnNewScoreCalculated(callback) {
      this.listeners.push(callback);
    }
    removeEventListenerOnNewScoreCalculated(callback) {
  ...
  if (typeof window !== "undefined") {
    window.scDetect = scDetect;
  }
  var index_default = scDetect;
})();
//# sourceMappingURL=sc-detect.browser.js.map
